...
public class Book extends Tuple5<String,String,Number, ImList<String>, ImList<BookItem>> {
    Book(String isbn, String title, Number publicationYear, ImList<String> authors, ImList<BookItem> bookItems) {
        super(isbn, title, publicationYear, authors, bookItems);
    }
    public String isbn() { return _1; }
    public String title() { return _2; }
    public Number publicationYear() { return _3; }
    public ImList<String> authors() { return _4; }
